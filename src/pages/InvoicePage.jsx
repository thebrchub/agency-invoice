      ...
      >
        ...
        <div className="flex justify-center pb-24 md:pb-0">
          <div className="transform scale-[0.45] sm:scale-[0.6] md:scale-100 origin-top transition-transform duration-200">
            <div className="bg-white w-[210mm] min-h-[297mm] mx-auto p-6 sm:p-12 shadow-xl relative text-gray-900 font-inter page-break-inside-avoid print:w-full print:max-w-none print:shadow-none">
              {/* Header */}
        ...
        {postDetails.length > 0 && (
          <div className="flex justify-center pb-24 md:pb-0">
            <div className="transform scale-[0.45] sm:scale-[0.6] md:scale-100 origin-top transition-transform duration-200 mt-10 md:mt-0">
              <div className="bg-white w-[210mm] min-h-[297mm] mx-auto p-6 sm:p-12 shadow-xl relative text-gray-900 page-break mt-8 font-inter print:mt-0 print:w-full print:max-w-none print:shadow-none print:h-auto">
                <div
